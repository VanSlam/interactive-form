//Zach Van Slambrook 2019
$(document).ready(function() {
  'use strict'
  // Set focus on the name field
  $('#name').focus()

  // Display input field for other
  $('.basic-info').append(
    '<input type="text" id="other-field" placeholder="Your job title" name="otherjob">'
  )
  $('#other-field').hide()

  // mofigy the function to display 'other' field
  ...
  // hid the color selector
  $('#colors-js-puns').hide()

  // Change function to display colors based on design
  // Form validation
  ...
  // creat total cost of all activities
  var totalCost = 0
